...
Cafe.create(user: User.first, name: "Craftsmen Coffee", description: "Established since 2013, we are inspired to serve great coffees with quality beans, hoping to bring a great end-to-end experiences for our customers in this fast pace country. We do believe that every cup matters and we are serious when it comes to our passion in making coffee, not to mention our dishes, which are delicious and well presented on your table.", neighbourhood: "Novena", address: "189 Thomson Rd, Singapore", city: "Singapore", category: "cafe", contact: "9658 0769")
Cafe.create(user: User.find(User.first.id + 1), name: "The Clue-less Goat", description: "Established since 2013, we are inspired to serve great coffees with quality beans, hoping to bring a great end-to-end experiences for our customers in this fast pace country. We do believe that every cup matters and we are serious when it comes to our passion in making coffee, not to mention our dishes, which are delicious and well presented on your table.", neighbourhood: "Novena", address: "173 Thomson Rd, Singapore", city: "Singapore", category: "cafe", contact: "8283 0885")
...
Cafe.all.each do |cafe|
  ...
  review7 = Review.new(user: User.find(User.first.id + rand(0..9)), cafe: cafe, content:"Neutral experience. Decent but could be better.", rating: 3)
  review8 = Review.new(user: User.find(User.first.id + rand(0..9)), cafe: cafe, content:"Staff was incredibly friendly and did not give me weird stares for staying in the cafe for so long. This app works!", rating: 4)
  review9 = Review.new(user: User.find(User.first.id + rand(0..9)), cafe: cafe, content:"Good environment and excellent location. Exactly as advertised.", rating: 5)
